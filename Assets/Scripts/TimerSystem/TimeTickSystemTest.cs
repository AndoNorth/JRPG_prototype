    ...
    public class TimeTickSystemTest : MonoBehaviour
    {
        ...
        private class TimerBar
        {
            ...
            public TimerBar(Vector3 position, int ticksToFinish, string timerBarName, Vector3 barSize)
            {
                ...
                _timerBar = new GeneralUtility.World_Bar(_gameObject.transform, new Vector3(0, 0), barSize, Color.white, Color.black, 1f, -10, GameAssets.instance.timerBarSortingLayer, new GeneralUtility.World_Bar.Outline());
